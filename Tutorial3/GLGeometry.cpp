...
GLsizei GL_GeneratePyramid(GLuint uiVBO, GLuint uiIBO)
{
    ...
    {
        // Create back face
        { vec3(0.0f,  0.5f,  0.0f), vec3(0.0f,  0.5f, -0.5f) },
        { vec3(0.5f, -0.5f, -0.5f), vec3(0.0f,  0.5f, -0.5f) },
        { vec3(-0.5f, -0.5f, -0.5f), vec3(0.0f,  0.5f, -0.5f) },
        // Create left face
        { vec3(0.0f,  0.5f,  0.0f), vec3(-0.5f,  0.5f,  0.0f) },
        { vec3(-0.5f, -0.5f, -0.5f), vec3(-0.5f,  0.5f,  0.0f) },
        { vec3(-0.5f, -0.5f,  0.5f), vec3(-0.5f,  0.5f,  0.0f) },
        // Create bottom face
        { vec3(0.5f, -0.5f, -0.5f), vec3(0.0f, -1.0f,  0.0f) },
        { vec3(0.5f, -0.5f,  0.5f), vec3(0.0f, -1.0f,  0.0f) },

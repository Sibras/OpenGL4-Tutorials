...
bool GL_Init()
{
    ...
    if (!GL_LoadShaderFile(uiFragmentShader, GL_FRAGMENT_SHADER, "PostProcessAO1stFrag.glsl", 1600))
        return false;
    ...
    // Load in ambient occlusion shader
    if (!GL_LoadShaderFile(uiFragmentShader, GL_FRAGMENT_SHADER, "PostProcessAO2ndFrag.glsl", 1700))
        return false;
    ...
    // Load in ambient occlusion shader
    if (!GL_LoadShaderFile(uiFragmentShader, GL_FRAGMENT_SHADER, "PostProcessVolSpots1stFrag.glsl", 1800))
        return false;
    ...
    // Load in ambient occlusion shader
    if (!GL_LoadShaderFile(uiFragmentShader, GL_FRAGMENT_SHADER, "PostProcessVolSpots2ndFrag.glsl", 1900))
        return false;
